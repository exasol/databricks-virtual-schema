...
local other_capabilities = {
    ...
    "FN_HASHTYPE_SHA1", "FN_HASHTYPE_SHA256", "FN_HASHTYPE_SHA512", "FN_HASHTYPE_TIGER", "FN_IS_BOOLEAN", "FN_IS_DATE",
    "FN_IS_DSINTERVAL", "FN_IS_NUMBER", "FN_IS_TIMESTAMP", "FN_IS_YMINTERVAL", "FN_JSON_VALUE", "FN_LEAST",
    "FN_NULLIFZERO", "FN_SESSION_PARAMETER", "FN_SYS_GUID", "FN_TYPEOF", "FN_ZEROIFNULL", -- 
    -- Aggregate functions
